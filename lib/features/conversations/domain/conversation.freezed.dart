...
mixin _$Conversation {
 ...
 String get id; String get contactName; String? get contactAvatarUrl; ChannelType get channel; ConversationStatus get status; String? get lastMessagePreview; DateTime? get lastMessageAt;// When the conversation thread was first created — shown in the
// customer detail panel's "Conversation room details".
 DateTime? get createdAt; int get unreadCount;// Mock-only for now — a real "assigned_to" column/UI lands in the
...
@override
int get hashCode => Object.hash(runtimeType,id,contactName,contactAvatarUrl,channel,status,lastMessagePreview,lastMessageAt,createdAt,unreadCount,assignedAgentName,lastMessageDirection);

@override
String toString() {
  return 'Conversation(id: $id, contactName: $contactName, contactAvatarUrl: $contactAvatarUrl, channel: $channel, status: $status, lastMessagePreview: $lastMessagePreview, lastMessageAt: $lastMessageAt, createdAt: $createdAt, unreadCount: $unreadCount, assignedAgentName: $assignedAgentName, lastMessageDirection: $lastMessageDirection)';
}
...
@useResult
$Res call({
 String id, String contactName, String? contactAvatarUrl, ChannelType channel, ConversationStatus status, String? lastMessagePreview, DateTime? lastMessageAt, DateTime? createdAt, int unreadCount, String? assignedAgentName, MessageDirection? lastMessageDirection
});
...
/// Create a copy of Conversation
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? contactName = null,Object? contactAvatarUrl = freezed,Object? channel = null,Object? status = null,Object? lastMessagePreview = freezed,Object? lastMessageAt = freezed,Object? createdAt = freezed,Object? unreadCount = null,Object? assignedAgentName = freezed,Object? lastMessageDirection = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String contactName,  String? contactAvatarUrl,  ChannelType channel,  ConversationStatus status,  String? lastMessagePreview,  DateTime? lastMessageAt,  DateTime? createdAt,  int unreadCount,  String? assignedAgentName,  MessageDirection? lastMessageDirection)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Conversation() when $default != null:
return $default(_that.id,_that.contactName,_that.contactAvatarUrl,_that.channel,_that.status,_that.lastMessagePreview,_that.lastMessageAt,_that.createdAt,_that.unreadCount,_that.assignedAgentName,_that.lastMessageDirection);case _:
  return orElse();
...
switch (_that) {
case _Conversation():
return $default(_that.id,_that.contactName,_that.contactAvatarUrl,_that.channel,_that.status,_that.lastMessagePreview,_that.lastMessageAt,_that.createdAt,_that.unreadCount,_that.assignedAgentName,_that.lastMessageDirection);}
}
...
class _Conversation implements Conversation {
  const _Conversation({required this.id, required this.contactName, this.contactAvatarUrl, required this.channel, required this.status, this.lastMessagePreview, this.lastMessageAt, this.createdAt, this.unreadCount = 0, this.assignedAgentName, this.lastMessageDirection});
...
/// Create a copy of Conversation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? contactName = null,Object? contactAvatarUrl = freezed,Object? channel = null,Object? status = null,Object? lastMessagePreview = freezed,Object? lastMessageAt = freezed,Object? createdAt = freezed,Object? unreadCount = null,Object? assignedAgentName = freezed,Object? lastMessageDirection = freezed,}) {
